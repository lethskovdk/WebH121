<template>
    <section class="become-member">
        <div container class="become-member__row">
            <div class="left">
                <div class="left__content">
                    <h1>Medlem?</h1>
                    <p>Vær med i kundeklubben for nye<br/>videoer, rabatkoder og mere!</p>
                    <RouterLink to="/Member">
                        <button class="btn-pink w-full">Bliv medlem af kundeklubben</button>
                    </RouterLink>
                </div>
            </div>
            <div class="right">
