...
<template>
    <li class="accordionItem" :class="showAccordion ? 'open' : 'closed'">
        <h2 @click="toggleAccordion" class="accordionItem__question mb-0">
            ...
            </svg> {{question.question}}</h2>
        <p class="accordionItem__answer mb-0">{{question.answer}}</p>
    </li>
</template>
